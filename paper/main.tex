...
\addcontentsline{toc}{section}{Introduction}
  ...
  As a result, the investments and the development of such a tool has become a pivotal and global trajectory for the future of many fields.  In response to the extraordi-nary growth in demand for AI services and the associated chiptechnology, AI-focused companies have experienced soaringstock prices, which have raised concerns about the potentialformation of speculative bubbles. 

  
  Major technology companies such as NVIDIA, META, or Microsoft have thus had a major increase in their stock prices in the past decade. 

  This can lead to the following question :  how relevant are traditional financial models in predicting AI stock prices ? 
  The Black-Scholes model, developed in 1973, presented a widely used option pricing formula. 
...
As shown in Figure~\ref{fig:meta_price}, META experienced substantial volatility during the post-pandemic AI expansion period.
